<template>
    <div class="blog-card">
        <div class="icons">
            ...
            <div class="icon">
                <img class="delete" :src="deleteSVG" alt="">
            </div>
        </div>
        <img class="img" :src="require(`../assets/blogCards/${post.blogCoverPhoto}.jpg`)" alt="">
        <div class="info">
            <h4>{{ post.blogTitle }}</h4>
            <h6>Posted on: {{ post.blogDate }}</h6>
            <router-link class="link" to="#">
                View the Post <img :src="arrowSVG" class="arrow" alt="">
            </router-link>
        </div>
    </div>
</template>
