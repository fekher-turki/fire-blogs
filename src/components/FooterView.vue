        ...
        <div class="container">
            <div class="left">
                <div class="col-1">
                    ...
                    <ul>
                        <li>
                            <a href="#"><img :src="youtube" class="svg-icon"></a>
                        </li>
                        <li>
                            <a href="#"><img :src="twitter" class="svg-icon"></a>
                        </li>
                        <li>
                            <a href="#"><img :src="instagram" class="svg-icon"></a>
                        </li>
                        <li>
                            <a href="#"><img :src="linkedin" class="svg-icon"></a>
                        </li>
                    </ul>
                </div>
                <div class="col-2">
...
export default {
    ...
    data() {
        return {
            youtube: require('../assets/Icons/youtube-brands.svg'),
